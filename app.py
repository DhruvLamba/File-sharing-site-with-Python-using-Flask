...
def show_files(username):
    return (os.listdir(path='C:\\Users\\pnkjl\\Desktop\\File-sharing-site-with-Python-using-Flask--master\\files\\'+username))
       
app = Flask(__name__)
UPLOAD_FOLDER ='C:\\Users\\pnkjl\\Desktop\\File-sharing-site-with-Python-using-Flask--master\\files\\'
...
def delete():
    if request.method=='GET':
        ...
        print(choose)
        os.remove(path='C:\\Users\\pnkjl\\Desktop\\File-sharing-site-with-Python-using-Flask--master\\files\\'+session.get('username', None)+'\\'+(choose))
        return redirect("http://127.0.0.1:4000/home",code=302)
